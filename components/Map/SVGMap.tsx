  ...
  return (
    ...
    >
      ...
      <path
        ...
        className="fill-blue-400/30 stroke-emerald-400/80"
        strokeWidth="0.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      ...
      <path
        d="M157 110L133 100.5L121 91L133.5 87.5L146 80.5L158 69.5L170 70.5L182 80.5L194 75.5L205.5 70.5L217.5 66L241 74.5L230 79.5L242 84L169.5 115L157 110Z"
        className="fill-gray-400/10 stroke-gray-500/80"
        strokeWidth="0.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      ...
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="stroke-gray-500/80"
      />

      {/* Dashed Beams */}
      <path
        d="M342.5 28L85 -1"
        className="animate-dashesReverse stroke-gray-400/40"
        strokeWidth="1"
...
const GradientColors = () => {
  return (
    <>
      ...
      <stop offset="0.325" stopColor="blue" />
